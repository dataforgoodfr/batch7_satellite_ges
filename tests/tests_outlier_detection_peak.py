...
# Test on one day outlier detection
# TODO: test this detection without parameter implement_filters set to False in gaussian_fit_on_df
...
print(peaks.shape)  # (108, 12) avec filters, (306,12) sans filter
...
# Test on all peaks of a month outlier detection and create csv with classif
